        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section__title text-center">
                    <h2 class="title__be--2" style="text-transform:none"><span class="color--theme">EN ÇOK</span> SATANLAR</h2>
                </div>
            </div>
        </div>
        <!-- Start Single Tab Content -->
        <div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
        @foreach($bestseller as $rs)
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb">
                            ...
                            <div class="hot__box">
                                <span class="hot-label" style="text-transform:none">EN ÇOK SATANLAR</span>
                            </div>
                        </div>
